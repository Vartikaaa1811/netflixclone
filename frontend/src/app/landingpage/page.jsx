      ...
      <div className="bg-gray-950">
        <div className="relative h-screen w-full ">
          ...
          <div className="absolute top-0 left-0 z-10 w-full h-full flex flex-col items-center justify-center text-white px-4 text-center">
            <div className="absolute top-16 left-16 h-12 md:h-16 lg:h-20   ">
              <Image
        ...
        <div className="absolute bottom-0 w-full h-32 bg-gradient-to-b from-transparent to-gray-950"></div>

        <div className="text-white bg-gray-950 px-12 py-12">
        ...
        <div className=" bg-gray-950 w-full h-full flex flex-col items-center justify-center text-white px-4 text-center">
          <p className="text-lg">
            Ready to watch? Enter your email to create or restart your
            membership.
          </p>
